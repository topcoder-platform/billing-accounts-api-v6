...
export class BillingAccountsController {
  ...
  async update(@Param('billingAccountId') id: string, @Body() dto: UpdateBillingAccountDto) {
  ...
  @Roles(ADMIN_ROLE)
  @Scopes(SCOPES.UPDATE_BA, SCOPES.ALL_BA)
  async lock(@Param('billingAccountId') id: string, @Body() dto: LockAmountDto) {
  ...
  @Roles(ADMIN_ROLE)
  @Scopes(SCOPES.UPDATE_BA, SCOPES.ALL_BA)
  async consume(@Param('billingAccountId') id: string, @Body() dto: ConsumeAmountDto) {
